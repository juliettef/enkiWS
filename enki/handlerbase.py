...
class HandlerBase( webapp2.RequestHandler ):
	...
	def redirect_to_relevant_page( self, abort = False ):
		...
		if ref and ref != home_page:
			...
			if self.is_logged_in():
				relevant_pages |= { '/profile', '/accountconnect', '/displayname', '/emailchange', '/passwordchange', '/friends', '/messages', '/admin/apps', '/appdatastores', '/loginaddconfirm', '/accountdelete', '/library' }
