...
def SEND_EMAIL_LOGIN_ATTEMPT_WITH_YOUR_EMAIL_NO_PW_BODY( link ): return _( "An attempt was made to log in to your account using this email address. If you'd like to use your email to log in, you need to set a password for it: \n\n%(link)s \n\n(click or copy and paste in your browser)", link = link )
def SEND_EMAIL_REGISTER_ATTEMPT_WITH_YOUR_EMAIL_SUBJECT(): return _( "Attempt to register with your email" )
def SEND_EMAIL_REGISTER_ATTEMPT_WITH_YOUR_EMAIL_BODY( link ): return _( "An attempt was made to sign up to your account using this email address. If you've forgotten your password, you can reset it: \n\n%(link)s \n\n(click or copy and paste in your browser)", link = link )
def SEND_EMAIL_REGISTER_CONFIRM_SUBJECT(): return _( "Registration confirmation" )
def SEND_EMAIL_REGISTER_CONFIRM_BODY( link ): return _( "Follow this link to confirm your registration: \n\n%(link)s \n\n(click or copy and paste in your browser)", link = link )
def SEND_EMAIL_EMAIL_CHANGE_CONFIRM_SUBJECT(): return _( "Confirm new email" )
def SEND_EMAIL_EMAIL_CHANGE_CONFIRM_BODY( link, email ): return _( "A request to change the email address linked to your account was made. Follow this link to confirm the change to address %(email)s: \n\n%(link)s \n\n(click or copy and paste in your browser)", email = email, link = link )
def SEND_EMAIL_EMAIL_CHANGE_UNDO_SUBJECT(): return _( "Undo change email" )
def SEND_EMAIL_EMAIL_CHANGE_UNDO_BODY( link, email ): return _( "A request to change the email address linked to your account was made. Follow this link to cancel the change and ensure the current address %(email)s remains linked to your account: \n\n%(link)s \n\n(click or copy and paste in your browser)", email = email, link = link )
def SEND_EMAIL_PASSWORD_RESET_SUBJECT(): return _( "Password reset" )
def SEND_EMAIL_PASSWORD_RESET_BODY( link ): return _( "A request to reset your password was made. Follow this link to reset your password and set a new one: \n\n%(link)s \n\n(click or copy and paste in your browser)", link = link )
def SEND_EMAIL_ACCOUT_DELETE_SUBJECT(): return _( "Account deletion" )
def SEND_EMAIL_ACCOUT_DELETE_BODY( link ): return _( "A request to delete your account was made. Follow this link to confirm deletion - WARNING: this cannot be undone! - \n\n%(link)s \n\n(click or copy and paste in your browser)", link = link )
def SEND_EMAIL_ACCOUT_POSTS_DELETE_SUBJECT(): return _( "Account and forum posts deletion" )
def SEND_EMAIL_ACCOUT_POSTS_DELETE_BODY( link ): return _( "A request to delete your account and your forum posts was made. Follow this link to confirm deletion - WARNING: this cannot be undone! - \n\n%(link)s \n\n(click or copy and paste in your browser)", link = link )
...
def SEND_EMAIL_EMAIL_SUBSCRIBE_CONFIRM_BODY( link, newsletter ): return _( "Follow this link to confirm your subscription to the %(newsletter)s email newsletter: \n\n%(link)s \n\n(click or copy and paste in your browser). \nIf you do not wish to subscribe, ignore this message.", link = link, newsletter = newsletter )
...
def SEND_EMAIL_EMAIL_NEWSLETTER_WELCOME_SUBJECT( newsletter ): return _( "%(newsletter)s newsletter welcome", newsletter = newsletter )
def SEND_EMAIL_EMAIL_NEWSLETTER_WELCOME_BODY( newsletter, link ): return _( "Welcome to the %(newsletter)s email newsletter. \nIf you wish to unsubscribe, follow this link: \n\n%(link)s \n\n(click or copy and paste in your browser).", newsletter = newsletter, link = link )
