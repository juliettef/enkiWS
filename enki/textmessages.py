...
def SEND_EMAIL_EMAIL_SUBSCRIBE_CONFIRM_BODY( link, newsletter ): return _("Follow this link to confirm your subscription to the %(newsletter)s newsletter: %(link)s (click or copy and paste in your browser). \nIf you do not wish to subscribe, ignore this message.", link = link, newsletter = newsletter)
